...
int main(int argc, char* argv[]){
    ...
    /*Set supplied number of processes or set default*/
    if(argc < 6){
        numProcs = atol(argv[5]);
    }
    else{
        numProcs = 5;
    }
    ...
    //The following is a snippet taken from Andy Sayler's pi-sched.c
    ...
    fprintf(stdout, "Process %d finished successfully\n", pid);
    return EXIT_SUCCESS;
}
